...
typedef void(^RPTrackCountCallback)(NSInteger count);
...
@property (assign, nonatomic) BOOL schedulerBlock;
...
- (void)getUnsentTraksCount:(RPTrackCountCallback)callback;
...
+ (void)setHeartbeatType:(HeartbeatType)value;
