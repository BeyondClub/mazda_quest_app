...
typedef void(^RPAPIInnerTrackCallback)(NSArray<NSDictionary<NSString *,id> *> * _Nonnull list);
...
@property (assign, nonatomic) NSInteger repeatCounter;
...
- (void)getOutcomingTracks:(RPAPIInnerTrackCallback)callback;

- (void)getUnsentTracks:(RPAPIInnerTrackCallback)callback;
