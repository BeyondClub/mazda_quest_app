...
typedef void(^RPDataTaskCallback)(Boolean success, Boolean needUpload);

+ (void)heartbeat: (NSString *)reason needUpload:(BOOL)needUpload callback:(nullable RPDataTaskCallback)callback;
+ (void)heartbeat: (NSString *)reason needUpload:(BOOL)needUpload rtlData:(nullable NSMutableDictionary*)rtlData callback:(nullable RPDataTaskCallback)callback;
