...
FOUNDATION_EXPORT NSTimeInterval const RPServerSchedulerTimeInterval;
...
+ (NSURLRequest *)requestTagWithPath:(NSString *)path baseURL:(NSString *)baseURL parameters:(NSDictionary *)params headers:(NSDictionary *)headers method:(NSString *)method;
