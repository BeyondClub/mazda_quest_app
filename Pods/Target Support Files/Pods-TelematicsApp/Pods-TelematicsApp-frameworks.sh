...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/CMTabbarView/CMTabbarView.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/CircleTimer/CircleTimer.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/CocoaLumberjack/CocoaLumberjack.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/DBCameraButton/DBCameraButton.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/GKImagePicker@robseward/GKImagePicker_robseward.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/IQMediaPickerController/IQMediaPickerController.framework"
  ...
  install_framework "${PODS_ROOT}/RaxelPulse/RaxelPulse.framework"
