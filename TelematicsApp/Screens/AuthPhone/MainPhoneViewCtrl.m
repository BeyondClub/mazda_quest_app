...
- (void)viewDidLoad {
    ...
    self.usePhoneLbl.textColor = [Color officialMainAppColor];
...
- (NSMutableAttributedString*)createJoinLabelImgCentered:(NSString*)joinText phoneText:(NSString*)phoneText {
    ...
    [textAfterIcon addAttribute:NSForegroundColorAttributeName value:[Color officialMainAppColor] range:NSMakeRange(0, [phoneUsageText length])];
