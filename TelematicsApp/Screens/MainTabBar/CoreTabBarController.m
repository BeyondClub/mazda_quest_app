...
//    NSArray *selectedImgArray = [NSArray arrayWithObjects:@"dashboard_selected", @"feed_selected", @"rewards_selected", @"profile_selected", nil];
    NSArray *unSelectedImgArray = [NSArray arrayWithObjects:@"dashboard_unselected", @"quests_selected", @"mazda_rewards_selected", @"rewards_unselected", @"profile_unselected", nil];
    NSArray *selectedImgArray = [NSArray arrayWithObjects:@"dashboard_selected", @"quests_unselected", @"mazda_rewards_unselected", @"rewards_selected", @"profile_selected", nil];
