...
@property(nonatomic, strong) NSNumber       *questsTabBarNumber; // 1
@property(nonatomic, strong) NSNumber       *rewardsTabBarNumber; // 2
@property(nonatomic, strong) NSNumber       *statsTabBarNumber; // 3
@property(nonatomic, strong) NSNumber       *profileTabBarNumber; // 4
